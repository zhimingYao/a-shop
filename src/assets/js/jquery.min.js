...
!(function (a, b) {
  ...
  var y,
    ...
    B = (n.fn.init = function (a, b) {
      ...
      if ('string' == typeof a) {
        if (
          ((c = '<' === a.charAt(0) && '>' === a.charAt(a.length - 1) && a.length >= 3 ? [null, a, null] : A.exec(a)), !c || (!c[1] && b))
        )
        ...
        ? (a && a.type
            ? ((this.originalEvent = a),
              ...
              (this.isDefaultPrevented =
                a.defaultPrevented ||
                (void 0 === a.defaultPrevented && (a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault())))
                  ? bb
                  : cb))
            : (this.type = a),
          b && n.extend(this, b),
  ...
  !(function () {
    ...
    function k() {
      ...
      h &&
        ...
        (g = !0),
        a.getComputedStyle &&
          ((f = '1%' !== (a.getComputedStyle(c, null) || {}).top), (e = '4px' === (a.getComputedStyle(c, null) || { width: '4px' }).width)),
        h.removeChild(b),
        (c = h = null));
    }
  })(),
  ...
  function lc(a, b, c) {
    var d,
      ...
      i = function () {
        if (e) return !1;
        for (
          var b = _b || gc(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length;
          i > g;
          g++
        )
          j.tweens[g].run(f);
