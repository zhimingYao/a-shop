<template>
  <div class="home">
    ...
    <div class="title">
      ...
      <div>
        <div class="clearfix shoplist">
          <shop-item v-for="(item, index) in list.anCard.slice(0, 4)" :key="index" :shop="item" :pshow="true" height="500px"
            width="360px"></shop-item>
        </div>
        <p>Skate shoes</p>
        <div>
        ...
        <p>Running shoes</p>
        <div>
    <swiper-vue :shop="list.SwiperCarousel" height="450px" type="card" :showhaden="false" width="500px" :loop="false"
            :autoplay="false" :end="20">
          </swiper-vue>
        </div>
        <p>Casual shoes</p>
   ...
   <swiper-vue :shop="list.SwiperColor" type="card" :Obscuration="true" height="600px"  :end="9"  :loop="false" :autoplay="false"> </swiper-vue>
        </div>
